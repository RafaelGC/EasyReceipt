/****************************************************************************
** Meta object code from reading C++ file 'delete.hpp'
**
...
#error "The header file 'delete.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Delete_t, stringdata) + ofs \
...
const QMetaObject Delete::staticMetaObject = {
    { &QVBoxLayout::staticMetaObject, qt_meta_stringdata_Delete.data,
      qt_meta_data_Delete,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Delete.stringdata))
