...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HistoryItem_t, stringdata) + ofs \
...
const QMetaObject HistoryItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HistoryItem.data,
      qt_meta_data_HistoryItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HistoryItem.stringdata))
