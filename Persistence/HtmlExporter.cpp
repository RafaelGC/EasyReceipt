...
HtmlExporter::HtmlExporter(Ticket *ticket, QString fullPath, Config *config):
...
void HtmlExporter::startTable()
{
    output << "<table border=\"2\">";
}

void HtmlExporter::listOfExpenses()
{
...
void HtmlExporter::individualExpenses()
{
...
void HtmlExporter::paymentDistribution()
{
    if (!thereArePayers()) return;
...
void HtmlExporter::closeTable()
{
    output << "</table>";
}

void HtmlExporter::footer()
{

    output << "</html>";
}

bool HtmlExporter::thereArePayers()
{
    return ticket->getPayers()->countPayers()>0;
}

bool HtmlExporter::exportToHtml()
{
